      ...
      <header className="sticky top-0 z-50 glass">
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Lekhani Logo" className="w-8 h-8 group-hover:scale-105 transition-transform duration-300" />
      ...
      <footer className="border-t border-gray-200 py-12 mt-20">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Lekhani Logo" className="w-6 h-6 grayscale opacity-60" />
